...
#define APP_NAME						"ACQSrv_IR"
#define MYID								1

#define SPECBRD_ID					2

#define DUT_TYPE						0x01
...
#define SC8R_CAL_PORT				"/dev/ttyUSB1"	// not used
#define SC8R_SEN_PORT				"/dev/ttyCalib"
#define SC8R_BAUDRATE				115200

#define FIRMWARE_FOLDER			"firmware/"

#define RADIO_RSSIPEAK_MIN	70
