...
/* Gestione latenze come per Proteus
   (Se ricevo in blocco tanti polling, gestisco solo l'ultimo)
   Serve a poco, si ingolfano molto anche i messaggi applicativi. */
#define PROTEUS
#include "cei_common_mps.c"
...
void _init()
{
  printf("CEI-ABI MPS (plugin, server): " __DATE__ " " __TIME__ "\n");
