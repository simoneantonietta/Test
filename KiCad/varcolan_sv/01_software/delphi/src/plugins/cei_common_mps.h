...
#define ALM_RIPARTENZA_PROGR	37
#define ALM_ACCESSO_OPER	38
#define ALM_VAR_PARAMETRI	39
...
#define ALM_STATO		64
#define ALM_COMANDO_LOCALE	65

#define CLS_NONE		 0
#define CLS_UNITA_CENTRALE	 1
#define CLS_UNITA_SATELLITE	 2
#define CLS_ORGANO_COMANDO	 3
#define CLS_ORGANO_USCITA	 7
#define CLS_GRP_ALIMENTAZIONE	 8
#define CLS_ZONA		 9
