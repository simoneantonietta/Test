...
//    This file contains definations for the Si443x EZ Radio Pro Transceiver.
//
// IDE:
...
#define  SI4431_OOK_COUNTER_V_1								0x2C //aggiunti nino
#define  SI4431_OOK_COUNTER_V_2								0x2D //aggiunti nino
#define  SI4431_SLICER_PEAK_HOLD							0x2E //aggiunti nino
...
#define  SI4432_IRSSI            0x10           //rssi supera soglia programmata
...
// SI4432_OPERATING_AND_FUNCTION_CONTROL_1             0x07
#define  SI4432_XTON             0x01              //1 in ready mode (osc on, 800uA) (se tutto il reg07 = 0: stby mode 450nA)
#define  SI4432_PLLON            0x02              //1 in tune mode (pll on, 8,5mA)
#define  SI4432_RXON             0x04
#define  SI4432_TXON             0x08
#define  SI4432_X32KSEL          0x10
#define  SI4432_ENWT             0x20
#define  SI4432_ENLBD            0x40
#define  SI4432_SWRES            0x80                //reset tutti i registri

// SI4432_OPERATING_AND_FUNCTION_CONTROL_2             0x08
#define  SI4432_TXFIFORESET      0x01
#define  SI4432_RXFIFORESET      0x02
#define  SI4432_ENLDM            0x04
#define  SI4432_AUTOTX           0x08
#define  SI4432_RXMULTIPK        0x10
...
// SI4432_IF_FILTER_BANDWIDTH                     0x1C       //non ho trovato spiegazioni
#define  SI4432_FILSET_MASK      0x0F
#define  SI4432_NDEC_MASK        0x70
#define  SI4432_DWN3_BYPASS      0x80

// SI4432_AFC_LOOP_GEARSHIFT_OVERRIDE            0x1D       //non ho trovato spiegazioni
#define  SI4432_AFCGEARH_MASK    0x3F
#define  SI4432_ENAFC            0x40
#define  SI4432_AFCBD            0x80

// SI4432_A_F_C_TIMING_CONTROL                     0x1E      //non ho trovato spiegazioni
#define  SI4432_LGWAIT_MASK      0x07
#define  SI4432_SHWAIT_MASK      0x38

// SI4432_CLOCK_RECOVERY_GEARSHIFT_OVERRIDE        0x1F     //non ho trovato spiegazioni
#define  SI4432_CRSLOW_MASK      0x07
#define  SI4432_CRFAST_MASK      0x38
#define  SI4432_RXREADY          0x40

// SI4432_CLOCK_RECOVERY_OVERSAMPLING_RATIO        0x20      //non ho trovato spiegazioni
// no bits or mask

// SI4432_CLOCK_RECOVERY_OFFSET_2 0x21                       //non ho trovato spiegazioni
...
// SI4432_RECEIVED_SIGNAL_STRENGTH_INDICATOR       0x26          //ronly RSSI
// no bits or mask

// SI4432_RSSI_THRESHOLD                           0x27         // R/W soglia rssi per interrupt
// no bits or mask

// SI4432_ANTENNA_DIVERSITY_REGISTER_1             0x28         //rssi su ant 1
// no bits or mask

// SI4432_ANTENNA_DIVERSITY_REGISTER_2             0x29         //rssi su ant 2
// no bits or mask
...
#define  SI4432_PREALEN_BIT8     0x01
...
#define  SI4432_TXPOW_MASK       0x07         //tx power (0/7)
...
#define  SI4432_MODTYP_MASK      0x03              //01 modulazione ook
#define  SI4432_FD_MASK          0x04              //0 bit 8 di freq dev
#define  SI4432_ENINV            0x08              //inverte tx e rx data
#define  SI4432_DTMOD_MASK       0x30              //00 direct mode con tx data da gpio
#define  SI4432_TRCLK_MASK       0xC0              //00 no tx data clk
#define  SI4432_MODTYP_GFSK      0x03
#define  SI4432_MODTYP_FSK       0x02
#define  SI4432_MODTYP_OOK       0x01
...
// SI4432_FREQUENCY_BAND_SELECTRESERVED            0x75          F = (f_b + 24 + ((f_c + f_o) / 64000)) * 10.000 * (hbsel+1) + (f_hch * f_hs * 10) [Khz]
#define  SI4432_FB_MASK          0x1F                            // f_b
#define  SI4432_HBSEL            0x20                            // hbsel
#define  SI4432_SBSEL            0x40

// SI4432_NOMINAL_CARRIER_FREQUENCY_1              0x76          //f_c(H)
// no bits or mask

// SI4432_NOMINAL_CARRIER_FREQUENCY_0              0x77          //f_c(L)
// no bits or mask

// SI4432_FREQUENCY_HOPPING_CHANNEL_SELECT         0x79         //f_hch
// no bits or mask

// SI4432_FREQUENCY_HOPPING_STEP_SIZE              0x7A         //f_hs
// no bits or mask
