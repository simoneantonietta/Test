...
//------------------------------------------------------------------------------
// Conditions for 19200 Baud SW UART, SMCLK = 1MHz
//------------------------------------------------------------------------------
...
int main(void)
{
    ...
    TACTL |= TACLR;
    TACCTL0 = CM0 + CCIS_0 + OUTMOD0 + CCIE + OUT;                          // Set TXD Idle as Mark = '1'
    TACCTL0 &= ~CAP;
//    TACCTL0 &= ~OUTMOD_7;
    TACCR0 = UART_TBIT;
    //TACCTL1 = SCS + CM1 + CAP + CCIE;       // Sync, Neg Edge, Capture, Int
    TACTL = TASSEL_2 + ID_0 + MC_1 ;                // SMCLK, start in up mode
