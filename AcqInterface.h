...
public:
	...
	try
		...
		ach->setupLinearConversion(-30665,-12303,0.95,9.5);
		...
		ach->setupLinearConversion(-29854,-4028,9.75,95.9);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=2;
		ach->setup("reed",ChannelBase::ch_analog_in);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=3;
		ach->setup("vcc",ChannelBase::ch_analog_in);
		ach->setupLinearConversion(0x0000,0x7fff,5,10.0);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=4;
		ach->setup("tamper1",ChannelBase::ch_analog_in);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=5;
		ach->setup("tamper2",ChannelBase::ch_analog_in);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=6;
		ach->setup("dut_gnd",ChannelBase::ch_analog_in);
		channel.push_back((ChannelBase*) ach);
		...
		ach->info.cfg=AD_U_10_V | AI_RSE;
		ach->channel=7;
		ach->setup("tp_generic",ChannelBase::ch_analog_in);
		channel.push_back((ChannelBase*) ach);
		...
		dch->channel=3;
		dch->setup("rele1",ChannelBase::ch_digital_out);
		channel.push_back((ChannelBase*) dch);
		...
		dch->info.portValue=&port1A;
		dch->channel=5;
		dch->setup("rele2",ChannelBase::ch_digital_out);
		channel.push_back((ChannelBase*) dch);
		...
		dch->info.portValue=&port1A;
		dch->channel=7;
		dch->setup("rele3",ChannelBase::ch_digital_out);
		channel.push_back((ChannelBase*) dch);
		...
		dch->channel=0;
		dch->setup("current_scale",ChannelBase::ch_digital_out);
		channel.push_back((ChannelBase*) dch);
		...
		dch->info.portValue=&port1CL;
		dch->channel=1;
		dch->setup("aux_cmd",ChannelBase::ch_digital_out);
		channel.push_back((ChannelBase*) dch);
